    ...
    private var backgroundTexture: SKTexture!
      ...
      private func layoutCurtain() {
          ...
          case .Bottom:
              ...
              curtain.texture = SKTexture(rect: subTextureRect(rect: sRect, ofParentRect: self.bgTextureRect), in: self.texture!)
      ...
      func relayout(parentSize size: CGSize) {
          ...
          case let x where x > 0:
              ...
              bgTexture = SKTexture(rect: subTextureRect, in: self.backgroundTexture)
          case let x where x < 0:
              let scale = tH / vH;
              let dW = vW * scale
